-- Script para adicionar a tabela de relatórios de pacientes ao banco de dados existente
-- Execute este script se o banco de dados já foi criado anteriormente
